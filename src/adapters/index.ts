 ...
 * with zero component changes. This is the acceptance criterion
 * "swapping MockAdapter for a stub ApiAdapter requires no changes to any
 * component" — it is enforced here, at the factory, and nowhere else.
 * ─────────────────────────────────────────────────────────────────────────────
 */
...
export { ApiAdapter, MockAdapter, WebSocketAdapter };
